...
export const Header = () => {
    ...
    const [img, setImg] = useState(LogoPredeterminado);
    ...
    /*useEffect(() => {
        ...
        const s = targetId.replace(/\s+/g, "").toLowerCase();
    ...
    return (
        <section className='headContainer'>
            ...
            <i
                className="bi bi-house-fill mainLogoHead"
                onClick={(e) => showSideBar(e)}
                    ...
                    <div className='side-menu'>
                        ...
                        <div>
                            ...
                            <div className='subm-container'>
                                <Link to={'/PriceList'} id='milistadeprecios' className='genLink' onClick={()=>{
                                    hideSideBar()
                                    setSection('Lista de precios')
                                }}>
                                    Lista de precios
                                </Link>
                        ...
                        <div>
                            ...
                            <div className='subm-container'>
                                <Link to={'/NewCustomer'} id='miclientes' className='genLink' onClick={(e)=>{
                                    setSomeData(null)
                                    hideSideBar()
                                    setSection('Clientes')
                                }}>
                        ...
                        <div>
                            ...
                            <div className='subm-container'>
                                <Link to={'/Newsupplier'} id='minuevoproveedor' className='genLink' onClick={(e)=>{
                                    setSomeData(null)
                                    hideSideBar()
                                ...
                                <Link to={'/SupplierList'} id='milistadeproveedores' className='genLink' onClick={(e)=>{
                                    setSomeData(null)
                                    hideSideBar()
                        ...
                        <div>
                            ...
                            <div className='subm-container'>
                                <Link to={'/NewWorker'} id='minuevocolaborador' className='genLink' onClick={(e)=>{
                                    setSomeData(null)
                                    hideSideBar()
